...
- 📚 [Virtual Bookshelf](https://github.com/Djiwan14/virtual-bookshelf) – Flask REST API with SQLite  
- 🌍 [OffbeatPlanner](https://github.com/Djiwan14/offbeatplanner) – Full-stack travel planner with Angular & FastAPI  
- 🕹️ [Pomodoro App](https://github.com/Djiwan14/pomodoro-timer) – Tkinter productivity tool  

<h3 align="left">Tech Stack Summary</h3>
<p>
  <img src="https://skillicons.dev/icons?i=python,java,django,spring,fastapi,flask,postgres,mysql,git,html,css,js,angular,docker,csharp,dotnet,mongodb,sqlite,bootstrap,bash,postman" />
</p>
